        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Control y administración de equipos de la ACG</p>
                </div>
                <div class="text-end">
            ...
            <div class="card shadow-lg border-0">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted fs-5 mb-4">
                        Estamos trabajando en el módulo de gestión de equipos para brindarte una experiencia completa de control de inventario.
                    </p>
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-4">
                            <div class="p-3">
                                ...
                                <h6 class="fw-bold">Registro de Equipos</h6>
                                <small class="text-muted">Agregar y gestionar Equipos de la ACG</small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="p-3">
