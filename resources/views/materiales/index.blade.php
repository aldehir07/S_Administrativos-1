    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1">Gestión de Materiales</h2>
                    <p class="text-muted mb-0">Control y administración de materiales del sistema</p>
                </div>
                <div class="text-end">
            ...
            <div class="card shadow-lg border-0">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted fs-5 mb-4">
                        Estamos trabajando en el módulo de gestión de materiales para brindarte una experiencia completa de control de inventario.
                    </p>
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-4">
                            <div class="p-3">
                                ...
                                <h6 class="fw-bold">Registro de Materiales</h6>
                                <small class="text-muted">Agregar y gestionar materiales del sistema</small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="p-3">
